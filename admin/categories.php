     ...
     <?php include 'header.php';?>
       <div id="page-wrapper">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">Add Categories Data </h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>

                      <form action="categoriesinsertcode.php" method="POST">
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <form action="categoriesupdatecode.php" method="POST">
              ...
              <div class="container">
                  <div class="jumbotron">
                      <div class="card">
                          <h2> Change Your Categories Information </h2>
                      </div>    
                      <div class="card">
                          <div class="card-body">
                              ...
                              if(isset($_POST['del']))
                    {
                        if(isset($_POST['chk']))
                        {
                            foreach ($_POST['chk'] as $check) {
                                $del="delete from categories where id='$check'";
