...
if(isset($_POST['login'])){
	...
	$check_login_row=mysqli_fetch_assoc(mysqli_query($connection,"select count(*) as total_count from clogin_log where try_time>$time and ip_address='$ip_address'"));
	...
	if($total_count==3){
		...
		$sql="select * from ragister where username='$username' and  password='$password'";
		...
		if(mysqli_num_rows($res)){
		   ...
		   {  
			...
			mysqli_query($connection,"delete from clogin_log where ip_address='$ip_address'");

			?>
			<script>
				window.location.href='/shor_o_shireen/index.php';
			</script>
			<?php
		}else{
    ...
    {  
     setcookie ("password","");  
			...
			$try_time=time();
			mysqli_query($connection,"insert into clogin_log(ip_address,try_time) values('$ip_address','$try_time')");
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="POST">
					...
					<div class="flex-sb-m w-full p-b-30">
						...
						<div>
							<a href="/shor_o_shireen/register.php" class="txt1">
								Register here!
							</a>
						</div>
