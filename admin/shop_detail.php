  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Shop Detail Data </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

        <form action="shop_detailinsertcode.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Edit Shop detail Data </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

        <form action="shop_detailupdatecode.php" method="POST" enctype="multipart/form-data">
...
<div class="container">
    <div class="jumbotron">
        <div class="card">
            <h2> Change Your Shop Detail page Information</h2>
        </div>    
        <div class="card">
            <div class="card-body">
                  ...
                  if(isset($_POST['del']))
                    {
                        if(isset($_POST['chk']))
                        {
                            foreach ($_POST['chk'] as $check) {
                                $del="delete from shop_detail where id='$check'";
                                mysqli_query($connection,$del);
                            }
                        }
                    }
                $query = "SELECT * FROM shop_detail";
                $query_run = mysqli_query($connection, $query);
            ?>
            <form action="shop_detail.php" method="POST">
