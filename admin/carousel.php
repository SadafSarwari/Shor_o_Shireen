  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="carouselinsertcode.php" method="POST" enctype="multipart/form-data">
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> Edit Carousel Data </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>

        <form action="carouselupdatecode.php" method="POST" enctype="multipart/form-data">
...
<div class="container">
    <div class="jumbotron">
        <div class="card">
            <h2> Change Your Carousel Content</h2>
        </div>    
        <div class="card">
            <div class="card-body">
                  ...
                  if(isset($_POST['del']))
                    {
                        if(isset($_POST['chk']))
                        {
                            foreach ($_POST['chk'] as $check) {
                                $del="delete from carousel where id='$check'";
